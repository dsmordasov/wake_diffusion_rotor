"""
This code was made for the purposes of running a AEP study on the wake
performance of a 2x2 wind farm, using the Joukowsky forcing model.
"""
# Imports
...
class UniformSite(UniformWeibullSite):
    def __init__(self, A, k, nsector=12.0, shear=None):  # TODO:  Add shear!
        UniformWeibullSite.__init__(self,
                                    # Sector frequencies [-]
                                    np.ones(int(nsector)) / float(nsector),
...
def run_jou_wf_2x2(ad_jou_rootdelta=0.25,
    ...
    e3d_model = EllipSys(wf, wt, wf.Ti, wt.zRef,  # Required positional arguments
                         ...
                         # Outer distance in the grid [D]
                         grid_radius_D=5e4/wt.D,
